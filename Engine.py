...
def analyze_data(file_path, start_date=None, end_date=None):
    try:
        ...
        # ======================
        # تم تطبيق حل الـ Region هنا
        # ======================
        sales_by_region = []
        if region:
            region_df = df.groupby(region)["revenue"].sum().fillna(0).reset_index()
            region_df = region_df.rename(columns={region: "region"}) # normalizing 
        ...
        result = {
            ...
            "charts": {
                "salesOverTime": {
                    "type": "line", "title": "Sales Over Time", "xKey": "month", "yKey": "revenue", "yLabel": "Revenue ($)", "data": sales_over_time
                },
                "profitOverTime": {
                    "type": "line", "title": "Profit Over Time", "xKey": "month", "yKey": "profit", "yLabel": "Profit ($)", "data": profit_over_time
                },
                "topProductsByProfit": {
                    "type": "bar", "title": "Top Products by Profit", "xKey": "productName", "yKey": "profit", "yLabel": "Profit ($)", "data": top_products
                },
                "bottomProductsByProfit": {
                    "type": "bar", "title": "Bottom Products by Profit", "xKey": "productName", "yKey": "profit", "yLabel": "Profit ($)", "data": bottom_products
                },
                "salesByRegion": {
                    "type": "pie", 
